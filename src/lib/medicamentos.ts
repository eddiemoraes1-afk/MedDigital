...
export interface Medicamento {
  ...
  /** Portaria 344/98 — undefined = sem controle especial
   *  'especial'       → Receita de Controle Especial (2 vias) — opioides, benzodiazepínicos, TDAH
   *  'antimicrobiano' → Receita de Antimicrobiano (2 vias) — antibióticos sistêmicos
   */
...
export const MEDICAMENTOS: Medicamento[] = [
  ...
  { principio: 'Tramadol', concentracao: '50mg', forma: 'cápsula', comerciais: ['Tramal', 'Sylador'], controle: 'especial' },
  { principio: 'Tramadol', concentracao: '100mg', forma: 'comprimido de liberação prolongada', comerciais: ['Tramal Retard'], controle: 'especial' },
  { principio: 'Codeína + Paracetamol', concentracao: '30mg + 500mg', forma: 'comprimido', comerciais: ['Tylex', 'Codex'], controle: 'especial' },
  { principio: 'Morfina', concentracao: '10mg/ml', forma: 'solução oral', comerciais: ['Dimorf'], controle: 'especial' },
  { principio: 'Morfina', concentracao: '10mg', forma: 'comprimido', comerciais: ['Dimorf'], controle: 'especial' },
  ...
  // ── ANTIBIÓTICOS ─────────────────────────────────────────────────────────────
  { principio: 'Amoxicilina', concentracao: '500mg', forma: 'cápsula', comerciais: ['Amoxil', 'Clavulin (+ ác. clavulânico)'], controle: 'antimicrobiano' },
  { principio: 'Amoxicilina', concentracao: '875mg', forma: 'comprimido', comerciais: ['Amoxil 875mg'], controle: 'antimicrobiano' },
  { principio: 'Amoxicilina', concentracao: '250mg/5ml', forma: 'pó para suspensão oral', comerciais: ['Amoxil Suspensão'], controle: 'antimicrobiano' },
  { principio: 'Amoxicilina + Clavulanato', concentracao: '875mg + 125mg', forma: 'comprimido', comerciais: ['Clavulin', 'Augmentin'], controle: 'antimicrobiano' },
  { principio: 'Amoxicilina + Clavulanato', concentracao: '400mg + 57mg/5ml', forma: 'pó para suspensão oral', comerciais: ['Clavulin BD Suspensão'], controle: 'antimicrobiano' },
  { principio: 'Azitromicina', concentracao: '500mg', forma: 'comprimido', comerciais: ['Zitromax', 'Azimed'], controle: 'antimicrobiano' },
  { principio: 'Azitromicina', concentracao: '200mg/5ml', forma: 'pó para suspensão oral', comerciais: ['Zitromax Suspensão'], controle: 'antimicrobiano' },
  ...
  { principio: 'Cefalexina', concentracao: '500mg', forma: 'cápsula', comerciais: ['Keflex', 'Ceporine'], controle: 'antimicrobiano' },
  { principio: 'Cefalexina', concentracao: '250mg/5ml', forma: 'pó para suspensão oral', comerciais: ['Keflex Suspensão'], controle: 'antimicrobiano' },
  { principio: 'Cefuroxima', concentracao: '500mg', forma: 'comprimido', comerciais: ['Zinnat'], controle: 'antimicrobiano' },
  { principio: 'Cefadroxila', concentracao: '500mg', forma: 'cápsula', comerciais: ['Cefamox', 'Duricef'] },
  { principio: 'Ciprofloxacino', concentracao: '500mg', forma: 'comprimido', comerciais: ['Cipro', 'Cifran'], controle: 'antimicrobiano' },
  { principio: 'Ciprofloxacino', concentracao: '250mg', forma: 'comprimido', comerciais: ['Cipro 250mg'], controle: 'antimicrobiano' },
  { principio: 'Levofloxacino', concentracao: '500mg', forma: 'comprimido', comerciais: ['Tavanic', 'Levaquin'], controle: 'antimicrobiano' },
  { principio: 'Levofloxacino', concentracao: '750mg', forma: 'comprimido', comerciais: ['Tavanic 750mg'], controle: 'antimicrobiano' },
  { principio: 'Moxifloxacino', concentracao: '400mg', forma: 'comprimido', comerciais: ['Avelox'], controle: 'antimicrobiano' },
  { principio: 'Doxiciclina', concentracao: '100mg', forma: 'comprimido', comerciais: ['Vibramycin', 'Doxifin'], controle: 'antimicrobiano' },
  { principio: 'Minociclina', concentracao: '100mg', forma: 'cápsula', comerciais: ['Minomax'] },
  { principio: 'Metronidazol', concentracao: '400mg', forma: 'comprimido', comerciais: ['Flagyl'], controle: 'antimicrobiano' },
  { principio: 'Metronidazol', concentracao: '500mg', forma: 'comprimido', comerciais: ['Flagyl 500mg'], controle: 'antimicrobiano' },
  { principio: 'Metronidazol', concentracao: '250mg/5ml', forma: 'suspensão oral', comerciais: ['Flagyl Suspensão'], controle: 'antimicrobiano' },
  { principio: 'Sulfametoxazol + Trimetoprima', concentracao: '800mg + 160mg', forma: 'comprimido', comerciais: ['Bactrim', 'Septrin'], controle: 'antimicrobiano' },
  { principio: 'Sulfametoxazol + Trimetoprima', concentracao: '200mg + 40mg/5ml', forma: 'suspensão oral', comerciais: ['Bactrim Suspensão'], controle: 'antimicrobiano' },
  { principio: 'Nitrofurantoína', concentracao: '100mg', forma: 'cápsula', comerciais: ['Macrodantina'], controle: 'antimicrobiano' },
  { principio: 'Fosfomicina', concentracao: '3g', forma: 'pó para solução oral (sachê)', comerciais: ['Monuril'] },
  { principio: 'Clindamicina', concentracao: '300mg', forma: 'cápsula', comerciais: ['Dalacin', 'Clindamicin'], controle: 'antimicrobiano' },
  { principio: 'Clindamicina', concentracao: '600mg', forma: 'cápsula', comerciais: ['Dalacin 600mg'], controle: 'antimicrobiano' },
  { principio: 'Eritromicina', concentracao: '500mg', forma: 'comprimido', comerciais: ['Pantomicina'], controle: 'antimicrobiano' },
  { principio: 'Penicilina Benzatina', concentracao: '1.200.000 UI', forma: 'pó para suspensão injetável', comerciais: ['Benzetacil 1.200.000 UI'], controle: 'antimicrobiano' },
  { principio: 'Penicilina Benzatina', concentracao: '2.400.000 UI', forma: 'pó para suspensão injetável', comerciais: ['Benzetacil 2.400.000 UI'], controle: 'antimicrobiano' },
  { principio: 'Vancomicina', concentracao: '500mg', forma: 'pó para solução injetável', comerciais: ['Vancocin'], controle: 'antimicrobiano' },
  ...
  { principio: 'Clonazepam', concentracao: '0,5mg', forma: 'comprimido', comerciais: ['Rivotril'], controle: 'especial' },
  { principio: 'Clonazepam', concentracao: '1mg', forma: 'comprimido', comerciais: ['Rivotril 1mg'], controle: 'especial' },
  { principio: 'Clonazepam', concentracao: '2mg', forma: 'comprimido', comerciais: ['Rivotril 2mg'], controle: 'especial' },
  { principio: 'Clonazepam', concentracao: '0,5mg/ml', forma: 'solução oral (gotas)', comerciais: ['Rivotril Gotas'], controle: 'especial' },
  { principio: 'Alprazolam', concentracao: '0,25mg', forma: 'comprimido', comerciais: ['Frontal', 'Xanax'], controle: 'especial' },
  { principio: 'Alprazolam', concentracao: '0,5mg', forma: 'comprimido', comerciais: ['Frontal 0,5mg'], controle: 'especial' },
  { principio: 'Alprazolam', concentracao: '1mg', forma: 'comprimido', comerciais: ['Frontal 1mg'], controle: 'especial' },
  { principio: 'Diazepam', concentracao: '5mg', forma: 'comprimido', comerciais: ['Valium', 'Ansileno'], controle: 'especial' },
  { principio: 'Diazepam', concentracao: '10mg', forma: 'comprimido', comerciais: ['Valium 10mg'], controle: 'especial' },
  { principio: 'Lorazepam', concentracao: '1mg', forma: 'comprimido', comerciais: ['Lorax'], controle: 'especial' },
  { principio: 'Bromazepam', concentracao: '3mg', forma: 'comprimido', comerciais: ['Lexotan'], controle: 'especial' },
  { principio: 'Bromazepam', concentracao: '6mg', forma: 'comprimido', comerciais: ['Lexotan 6mg'], controle: 'especial' },
  ...
  { principio: 'Zolpidem', concentracao: '10mg', forma: 'comprimido', comerciais: ['Stilnox'], controle: 'especial' },
  ...
  { principio: 'Doxiciclina', concentracao: '100mg', forma: 'comprimido', comerciais: ['Vibramycin'], controle: 'antimicrobiano' },
  ...
  { principio: 'Amoxicilina', concentracao: '125mg/5ml', forma: 'pó para suspensão oral (pediátrico)', comerciais: ['Amoxil Pediátrico 125mg'], controle: 'antimicrobiano' },
  { principio: 'Amoxicilina + Clavulanato', concentracao: '200mg + 28,5mg/5ml', forma: 'pó para suspensão oral (pediátrico)', comerciais: ['Clavulin Pediátrico BD'], controle: 'antimicrobiano' },
  { principio: 'Cefalexina', concentracao: '125mg/5ml', forma: 'pó para suspensão oral (pediátrico)', comerciais: ['Keflex Infantil'], controle: 'antimicrobiano' },
  ...
  { principio: 'Fenobarbital', concentracao: '40mg/ml', forma: 'solução oral (gotas)', comerciais: ['Gardenal Gotas'], controle: 'especial' },
  { principio: 'Fenobarbital', concentracao: '100mg', forma: 'comprimido', comerciais: ['Gardenal 100mg'], controle: 'especial' },
  ...
  { principio: 'Rifampicina', concentracao: '300mg', forma: 'cápsula', comerciais: ['Rifampicina', 'Rifaldin 300mg'], controle: 'antimicrobiano' },
  { principio: 'Rifampicina', concentracao: '150mg/5ml', forma: 'suspensão oral', comerciais: ['Rifampicina Suspensão'], controle: 'antimicrobiano' },
  { principio: 'Isoniazida', concentracao: '100mg', forma: 'comprimido', comerciais: ['Isoniazida 100mg', 'INH 100mg'], controle: 'antimicrobiano' },
  { principio: 'Isoniazida', concentracao: '300mg', forma: 'comprimido', comerciais: ['Isoniazida 300mg'], controle: 'antimicrobiano' },
  { principio: 'Pirazinamida', concentracao: '500mg', forma: 'comprimido', comerciais: ['Pirazinamida 500mg'], controle: 'antimicrobiano' },
  { principio: 'Etambutol', concentracao: '400mg', forma: 'comprimido', comerciais: ['Myambutol', 'Etambutol 400mg'], controle: 'antimicrobiano' },
  { principio: 'RHZE (Rifampicina + Isoniazida + Pirazinamida + Etambutol)', concentracao: '150mg+75mg+400mg+275mg', forma: 'comprimido (dose fixa combinada — fase intensiva TB)', comerciais: ['RHZE — Esquema MS'], controle: 'antimicrobiano' },
  { principio: 'RH (Rifampicina + Isoniazida)', concentracao: '300mg + 150mg', forma: 'comprimido (dose fixa — fase manutenção TB)', comerciais: ['RH — Manutenção TB MS'], controle: 'antimicrobiano' },
  ...
  { principio: 'Ampicilina', concentracao: '500mg', forma: 'cápsula', comerciais: ['Binotal 500mg', 'Ampicilina 500mg'], controle: 'antimicrobiano' },
  { principio: 'Ampicilina', concentracao: '250mg/5ml', forma: 'pó para suspensão oral', comerciais: ['Binotal Suspensão'], controle: 'antimicrobiano' },
  { principio: 'Ceftriaxona', concentracao: '1g', forma: 'pó para solução injetável', comerciais: ['Rocefin 1g', 'Ceftriaxona 1g'], controle: 'antimicrobiano' },
  { principio: 'Ceftriaxona', concentracao: '500mg', forma: 'pó para solução injetável', comerciais: ['Rocefin 500mg'], controle: 'antimicrobiano' },
  ...
  // ── PSIQUIATRIA — TDAH ────────────────────────────────────────────────────────
  { principio: 'Metilfenidato', concentracao: '10mg', forma: 'comprimido', comerciais: ['Ritalina 10mg'], controle: 'especial' },
  { principio: 'Metilfenidato', concentracao: '20mg', forma: 'comprimido', comerciais: ['Ritalina 20mg'], controle: 'especial' },
  { principio: 'Metilfenidato', concentracao: '18mg', forma: 'comprimido de liberação controlada', comerciais: ['Concerta 18mg', 'Ritalina LA 18mg'], controle: 'especial' },
  { principio: 'Metilfenidato', concentracao: '27mg', forma: 'comprimido de liberação controlada', comerciais: ['Concerta 27mg'], controle: 'especial' },
  { principio: 'Metilfenidato', concentracao: '36mg', forma: 'comprimido de liberação controlada', comerciais: ['Concerta 36mg', 'Ritalina LA 36mg'], controle: 'especial' },
  { principio: 'Metilfenidato', concentracao: '54mg', forma: 'comprimido de liberação controlada', comerciais: ['Concerta 54mg'], controle: 'especial' },
  { principio: 'Lisdexanfetamina', concentracao: '20mg', forma: 'cápsula', comerciais: ['Venvanse 20mg'], controle: 'especial' },
  { principio: 'Lisdexanfetamina', concentracao: '30mg', forma: 'cápsula', comerciais: ['Venvanse 30mg'], controle: 'especial' },
  { principio: 'Lisdexanfetamina', concentracao: '40mg', forma: 'cápsula', comerciais: ['Venvanse 40mg'], controle: 'especial' },
  { principio: 'Lisdexanfetamina', concentracao: '50mg', forma: 'cápsula', comerciais: ['Venvanse 50mg'], controle: 'especial' },
  { principio: 'Lisdexanfetamina', concentracao: '60mg', forma: 'cápsula', comerciais: ['Venvanse 60mg'], controle: 'especial' },
  { principio: 'Lisdexanfetamina', concentracao: '70mg', forma: 'cápsula', comerciais: ['Venvanse 70mg'], controle: 'especial' },
  ...
  // ── ANTIGRIPAIS / RESFRIADOS / DESCONGESTIONANTES ────────────────────────────
  { principio: 'Paracetamol + Ácido Acetilsalicílico + Cafeína', concentracao: '250mg + 250mg + 65mg', forma: 'comprimido', comerciais: ['Apracur', 'Doril Enxaqueca', 'Excedrin'] },
  { principio: 'Paracetamol + Cafeína', concentracao: '500mg + 65mg', forma: 'comprimido', comerciais: ['Tylenol Enxaqueca', 'Doril Composto'] },
  { principio: 'Paracetamol + Fenilefrina + Clorfeniramina', concentracao: '500mg + 10mg + 4mg', forma: 'comprimido', comerciais: ['Resfenol', 'Naldecon', 'Multigripe', 'Coristina D'] },
  { principio: 'Paracetamol + Fenilefrina + Clorfeniramina', concentracao: '1g + 10mg + 4mg', forma: 'sachê para solução oral', comerciais: ['Naldecon Sachê', 'Resfriex Sachê', 'Multigripe Sachê'] },
  { principio: 'Paracetamol + Fenilefrina + Clorfeniramina', concentracao: '160mg + 5mg + 2mg/5ml', forma: 'suspensão oral (pediátrico)', comerciais: ['Naldecon Pediátrico', 'Coristina D Pediátrico'] },
  { principio: 'Paracetamol + Fenilefrina', concentracao: '500mg + 10mg', forma: 'comprimido', comerciais: ['Gripex', 'Dimetapp Dor e Febre'] },
  { principio: 'Ibuprofeno + Pseudoefedrina', concentracao: '200mg + 30mg', forma: 'comprimido', comerciais: ['Advil Sinus', 'Alivium Sinus'] },
  { principio: 'Loratadina + Pseudoefedrina', concentracao: '5mg + 120mg', forma: 'comprimido de liberação prolongada', comerciais: ['Claritin-D 12h', 'Lorafed D'] },
  { principio: 'Cetirizina + Pseudoefedrina', concentracao: '5mg + 120mg', forma: 'comprimido de liberação prolongada', comerciais: ['Zyrtec-D', 'Reactine D'] },
  { principio: 'Pseudoefedrina', concentracao: '60mg', forma: 'comprimido', comerciais: ['Sudafed 60mg', 'Pseudoefedrina 60mg'] },
  { principio: 'Pseudoefedrina', concentracao: '120mg', forma: 'comprimido de liberação prolongada', comerciais: ['Sudafed 12h'] },
  { principio: 'Fenilefrina', concentracao: '10mg', forma: 'comprimido', comerciais: ['Rinopan', 'Descongex Plus', 'Fenilefrina 10mg'] },
  { principio: 'Fenilefrina', concentracao: '0,25%', forma: 'solução nasal (gotas/spray)', comerciais: ['Sorine 0,25%', 'Rinopan Nasal'] },
  { principio: 'Maleato de Clorfeniramina', concentracao: '4mg', forma: 'comprimido', comerciais: ['Clorfeniramina 4mg', 'Histamin'] },
  { principio: 'Maleato de Clorfeniramina', concentracao: '2mg/5ml', forma: 'xarope', comerciais: ['Clorfeniramina Xarope'] },
  { principio: 'Dexclorfeniramina', concentracao: '2mg', forma: 'comprimido', comerciais: ['Polaramine 2mg'] },
  { principio: 'Dexclorfeniramina', concentracao: '2mg/5ml', forma: 'xarope', comerciais: ['Polaramine Xarope'] },
  { principio: 'Dexclorfeniramina + Betametasona', concentracao: '2mg + 0,25mg/5ml', forma: 'xarope', comerciais: ['Celestamine Xarope', 'Predniamine Xarope'] },
  { principio: 'Dexclorfeniramina + Betametasona', concentracao: '2mg + 0,25mg', forma: 'comprimido', comerciais: ['Celestamine Comprimido'] },
  { principio: 'Fenilefrina + Guaifenesina + Dextrometorfano', concentracao: '5mg + 100mg + 10mg/5ml', forma: 'xarope', comerciais: ['Naldecon DX Adulto', 'Sinutab Expectorante'] },
  { principio: 'Dextrometorfano + Guaifenesina', concentracao: '10mg + 100mg/5ml', forma: 'xarope', comerciais: ['Vick 44E', 'Benylin DM-E', 'Robitussin DM'] },
  { principio: 'Levodropropizina', concentracao: '6mg/ml', forma: 'xarope', comerciais: ['Antux', 'Levotoss'] },
  { principio: 'Levodropropizina', concentracao: '60mg', forma: 'comprimido', comerciais: ['Antux Comprimido'] },
  { principio: 'Butamirato', concentracao: '5mg/5ml', forma: 'xarope (antitussígeno)', comerciais: ['Silomat', 'Tosse Seca'] },
  { principio: 'Butamirato + Guaifenesina', concentracao: '5mg + 50mg/5ml', forma: 'xarope', comerciais: ['Silomat Composto'] },
  { principio: 'Bromexina', concentracao: '8mg', forma: 'comprimido', comerciais: ['Bisolvon 8mg', 'Bromexina 8mg'] },
  { principio: 'Bromexina', concentracao: '4mg/5ml', forma: 'xarope', comerciais: ['Bisolvon Xarope', 'Bromexina Xarope'] },
  { principio: 'Prometazina', concentracao: '25mg', forma: 'comprimido', comerciais: ['Fenergan 25mg', 'Prometazina 25mg'] },
  { principio: 'Prometazina', concentracao: '6,25mg/5ml', forma: 'xarope', comerciais: ['Fenergan Xarope'] },
  { principio: 'Prometazina', concentracao: '25mg/ml', forma: 'solução injetável', comerciais: ['Fenergan Injetável'] },

  // ── VITAMINAS INDIVIDUAIS ─────────────────────────────────────────────────────
  { principio: 'Ácido Ascórbico (Vitamina C)', concentracao: '500mg', forma: 'comprimido', comerciais: ['Cewin 500mg', 'Redoxon 500mg'] },
  { principio: 'Ácido Ascórbico (Vitamina C)', concentracao: '1g', forma: 'comprimido', comerciais: ['Cewin 1g', 'Vitacef 1g'] },
  { principio: 'Ácido Ascórbico (Vitamina C)', concentracao: '1g', forma: 'comprimido efervescente', comerciais: ['Redoxon 1g Efervescente', 'Natele C 1g'] },
  { principio: 'Ácido Ascórbico (Vitamina C)', concentracao: '200mg/ml', forma: 'solução oral (gotas)', comerciais: ['Cewin Gotas', 'Vitamina C Gotas'] },
  { principio: 'Ácido Ascórbico + Zinco', concentracao: '500mg + 10mg', forma: 'comprimido efervescente', comerciais: ['Redoxon Dupla Ação', 'Vitamina C + Zinco'] },
  { principio: 'Vitamina A (Retinol)', concentracao: '10.000 UI', forma: 'cápsula', comerciais: ['Vitamina A 10000 UI', 'Arovit'] },
  { principio: 'Vitamina A (Retinol)', concentracao: '50.000 UI', forma: 'cápsula (dose de ataque — protocolo MS)', comerciais: ['Vitamina A 50000 UI'] },
  { principio: 'Vitamina A + D3', concentracao: '5.000 UI + 500 UI/ml', forma: 'solução oral (gotas)', comerciais: ['Adexon Gotas', 'Vitamina AD Gotas'] },
  { principio: 'Tocoferol (Vitamina E)', concentracao: '400 UI', forma: 'cápsula', comerciais: ['Ephynal 400 UI', 'Vitamina E 400 UI'] },
  { principio: 'Tocoferol (Vitamina E)', concentracao: '800 UI', forma: 'cápsula', comerciais: ['Vitamina E 800 UI'] },
  { principio: 'Tiamina (Vitamina B1)', concentracao: '300mg', forma: 'comprimido', comerciais: ['Benerva 300mg', 'Tiamina 300mg'] },
  { principio: 'Tiamina (Vitamina B1)', concentracao: '100mg/ml', forma: 'solução injetável', comerciais: ['Benerva Injetável', 'Tiamina Injetável'] },
  { principio: 'Riboflavina (Vitamina B2)', concentracao: '10mg', forma: 'comprimido', comerciais: ['Riboflavina 10mg', 'Vitamina B2'] },
  { principio: 'Piridoxina (Vitamina B6)', concentracao: '40mg', forma: 'comprimido', comerciais: ['Piridoxina 40mg', 'B6 40mg'] },
  { principio: 'Piridoxina (Vitamina B6)', concentracao: '300mg', forma: 'comprimido', comerciais: ['Piridoxina 300mg'] },
  { principio: 'Piridoxina (Vitamina B6)', concentracao: '100mg/ml', forma: 'solução injetável', comerciais: ['Piridoxina Injetável'] },
  { principio: 'Piridoxina + Cianocobalamina + Ácido Fólico', concentracao: '40mg + 1mg + 5mg', forma: 'comprimido', comerciais: ['Tenavit B', 'Neurobion Composto'] },
  { principio: 'Cianocobalamina (Vitamina B12)', concentracao: '1.000mcg/ml', forma: 'solução injetável', comerciais: ['Cianocobalamina Injetável 1000mcg'] },
  { principio: 'Cianocobalamina (Vitamina B12)', concentracao: '5.000mcg/ml', forma: 'solução injetável', comerciais: ['Cianocobalamina Injetável 5000mcg'] },
  { principio: 'Niacina (Vitamina B3)', concentracao: '500mg', forma: 'comprimido', comerciais: ['Niaspan 500mg', 'Niacina 500mg'] },
  { principio: 'Ácido Pantotênico (Vitamina B5)', concentracao: '500mg', forma: 'cápsula', comerciais: ['Vitamina B5 500mg', 'Pantotenato de Cálcio'] },
  { principio: 'Biotina', concentracao: '5mg', forma: 'comprimido', comerciais: ['Biotina 5mg', 'Biotina Plus'] },
  { principio: 'Biotina', concentracao: '10mg', forma: 'comprimido', comerciais: ['Biotina 10mg'] },
  { principio: 'Complexo B + Vitamina C', concentracao: '—', forma: 'comprimido', comerciais: ['Complexo B + C', 'Addera B12 + C'] },
  { principio: 'Complexo B + C', concentracao: '—', forma: 'solução injetável', comerciais: ['Polivitamínico Injetável', 'Complexo B + C Injetável'] },
  { principio: 'Vitamina D3 + K2', concentracao: '2.000 UI + 45mcg', forma: 'cápsula', comerciais: ['Vitamina D3+K2', 'Ativum D3K2'] },
  { principio: 'Vitamina D3 + K2', concentracao: '5.000 UI + 90mcg', forma: 'cápsula', comerciais: ['Vitamina D3+K2 5000 UI'] },
  { principio: 'Polivitamínico + Minerais', concentracao: '—', forma: 'comprimido', comerciais: ['Centrum', 'Supletil', 'Daily Vit'] },
  { principio: 'Glucosamina', concentracao: '1.500mg', forma: 'sachê / comprimido', comerciais: ['Artivit', 'Glucosamina 1500mg'] },
  { principio: 'Glucosamina + Condroitina', concentracao: '1.500mg + 1.200mg', forma: 'sachê / comprimido', comerciais: ['Condroflex', 'Osteo Bi-Flex', 'Cartilac Plus'] },
  { principio: 'Colágeno Hidrolisado', concentracao: '10g', forma: 'pó para solução oral (sachê)', comerciais: ['Colágeno 10g', 'Verisol', 'HC Collagen'] },
  { principio: 'Coenzima Q10', concentracao: '100mg', forma: 'cápsula', comerciais: ['CoQ10 100mg', 'Ubiquinol 100mg'] },
  { principio: 'L-Triptofano', concentracao: '500mg', forma: 'cápsula', comerciais: ['Triptofano 500mg'] },
  { principio: 'Potássio (Cloreto de Potássio)', concentracao: '600mg', forma: 'comprimido', comerciais: ['KCl 600mg', 'Slow-K'] },
  { principio: 'Potássio (Cloreto de Potássio)', concentracao: '10%', forma: 'solução oral', comerciais: ['KCl Oral 10%'] },
  { principio: 'Magnésio Quelado', concentracao: '250mg', forma: 'cápsula', comerciais: ['Magnésio Quelado 250mg', 'Magnesil'] },
  { principio: 'Ferro Polimaltosado', concentracao: '50mg/ml', forma: 'solução oral (gotas)', comerciais: ['Noripurum Oral Gotas', 'Ferastral Gotas'] },
  { principio: 'Ferro Polimaltosado', concentracao: '150mg', forma: 'comprimido', comerciais: ['Noripurum Oral 150mg', 'Ferastral 150mg'] },

  // ── PROBIÓTICOS ───────────────────────────────────────────────────────────────
  { principio: 'Saccharomyces boulardii', concentracao: '200mg', forma: 'sachê', comerciais: ['Floratil 200mg Sachê', 'Florajen Sachê'] },
  { principio: 'Saccharomyces boulardii', concentracao: '200mg', forma: 'cápsula', comerciais: ['Floratil 200mg Cápsula'] },
  { principio: 'Bacillus clausii', concentracao: '2 × 10⁹ esporos/5ml', forma: 'suspensão oral (frasco)', comerciais: ['Enterogermina', 'Bacillus clausii Frasco'] },
  { principio: 'Lactobacillus acidophilus + Lactobacillus rhamnosus', concentracao: '1 × 10⁹ UFC', forma: 'sachê', comerciais: ['Probiatop', 'Lactobact Sachê'] },
  { principio: 'Lactobacillus reuteri', concentracao: '1 × 10⁸ UFC/5 gotas', forma: 'solução oral (gotas)', comerciais: ['BioGaia Gotas', 'Colicare Gotas'] },
  { principio: 'Lactobacillus rhamnosus GG', concentracao: '10⁹ UFC', forma: 'cápsula / sachê', comerciais: ['Culturelle', 'LGG Sachê'] },
  { principio: 'Bifidobacterium longum + Lactobacillus helveticus', concentracao: '3 × 10⁹ UFC', forma: 'cápsula', comerciais: ['Lacteol Fort', 'Bioflorin Plus'] },
  { principio: 'Lactase (β-galactosidase)', concentracao: '3.000 FCC', forma: 'cápsula / comprimido mastigável', comerciais: ['Lactaid', 'Kerulac', 'Lactofree'] },

  // ── DIGESTIVOS / ANTIÁCIDOS / PROTETORES GÁSTRICOS OTC ───────────────────────
  { principio: 'Hidróxido de Alumínio', concentracao: '400mg/5ml', forma: 'suspensão oral', comerciais: ['Pepsamar', 'Mylanta Pura'] },
  { principio: 'Hidróxido de Alumínio + Hidróxido de Magnésio', concentracao: '200mg + 200mg', forma: 'comprimido mastigável', comerciais: ['Maalox Comprimido', 'Mylanta Comprimido'] },
  { principio: 'Hidróxido de Alumínio + Hidróxido de Magnésio', concentracao: '400mg + 400mg/10ml', forma: 'suspensão oral', comerciais: ['Maalox Suspensão', 'Mylanta II'] },
  { principio: 'Carbonato de Cálcio', concentracao: '500mg', forma: 'comprimido mastigável (antiácido)', comerciais: ['Tums 500mg', 'Calfort Antiácido'] },
  { principio: 'Alginato de Sódio + Bicarbonato de Sódio', concentracao: '500mg + 267mg/10ml', forma: 'suspensão oral', comerciais: ['Gaviscon', 'Refluxon'] },
  { principio: 'Bicarbonato de Sódio + Ácido Cítrico + Carbonato de Sódio', concentracao: '—', forma: 'pó para solução oral (sachê antiácido)', comerciais: ['ENO Sal de Fruta', 'Sonrisal'] },
  { principio: 'Famotidina', concentracao: '20mg', forma: 'comprimido', comerciais: ['Pepcidin 20mg', 'Famox 20mg'] },
  { principio: 'Famotidina', concentracao: '40mg', forma: 'comprimido', comerciais: ['Pepcidin 40mg'] },
  { principio: 'Pancreatina', concentracao: '10.000 UI lipase', forma: 'cápsula entérica', comerciais: ['Creon 10000', 'Panzitrat 10000'] },
  { principio: 'Pancreatina', concentracao: '25.000 UI lipase', forma: 'cápsula entérica', comerciais: ['Creon 25000', 'Panzitrat 25000'] },
  { principio: 'Bromelina', concentracao: '300mg', forma: 'comprimido', comerciais: ['Bromelina 300mg', 'Ananase 300mg'] },
  { principio: 'Racecadotril (Acetorfano)', concentracao: '100mg', forma: 'sachê (antidiarreico)', comerciais: ['Tiorfan 100mg', 'Racecadotril Sachê'] },
  { principio: 'Racecadotril (Acetorfano)', concentracao: '30mg', forma: 'sachê (pediátrico)', comerciais: ['Tiorfan 30mg Pediátrico'] },
  { principio: 'Trimebutina', concentracao: '100mg', forma: 'comprimido', comerciais: ['Polibutin 100mg', 'Tributil 100mg'] },
  { principio: 'Trimebutina', concentracao: '200mg', forma: 'comprimido', comerciais: ['Polibutin 200mg'] },
  { principio: 'Trimebutina', concentracao: '10mg/5ml', forma: 'suspensão oral', comerciais: ['Polibutin Pediátrico', 'Tributil Suspensão'] },
  { principio: 'Mebeverina', concentracao: '135mg', forma: 'comprimido', comerciais: ['Duspatalin 135mg'] },
  { principio: 'Mebeverina', concentracao: '200mg', forma: 'cápsula de liberação prolongada', comerciais: ['Duspatalin Retard 200mg'] },
  { principio: 'Brometo de Otilônio', concentracao: '40mg', forma: 'comprimido', comerciais: ['Spasmomen 40mg'] },
  { principio: 'Brometo de Pinavério', concentracao: '100mg', forma: 'comprimido', comerciais: ['Dicetel 100mg'] },
  { principio: 'Brometo de Pinavério', concentracao: '50mg', forma: 'comprimido', comerciais: ['Dicetel 50mg'] },
  { principio: 'Dimeticona', concentracao: '40mg/ml', forma: 'solução oral (gotas, antiflatulento)', comerciais: ['Anfasil Gotas', 'Bebê Conforto', 'Dimeticona Gotas'] },
  { principio: 'Carvão Ativado', concentracao: '500mg', forma: 'cápsula / comprimido', comerciais: ['Carvão Ativado Medicinalis', 'CharcoCaps'] },

  // ── ANTIPARASITÁRIOS COMPLEMENTARES ──────────────────────────────────────────
  { principio: 'Pamoato de Pirantel', concentracao: '250mg/5ml', forma: 'suspensão oral', comerciais: ['Combantrin Suspensão', 'Helmintox Suspensão', 'Ascaridil Suspensão'] },
  { principio: 'Pamoato de Pirantel', concentracao: '750mg', forma: 'comprimido (dose única)', comerciais: ['Combantrin 750mg', 'Helmintox 750mg'] },
  { principio: 'Praziquantel', concentracao: '600mg', forma: 'comprimido', comerciais: ['Cestox 600mg', 'Biltricide 600mg'] },
  { principio: 'Secnidazol', concentracao: '1g', forma: 'sachê granulado (dose única)', comerciais: ['Secnidal 1g', 'Gynokan 1g', 'Unigyl 1g'] },
  { principio: 'Secnidazol', concentracao: '2g', forma: 'sachê granulado (dose única)', comerciais: ['Secnidal 2g', 'Unigyl 2g'] },
  { principio: 'Secnidazol', concentracao: '500mg', forma: 'comprimido', comerciais: ['Secnidal 500mg'] },
  { principio: 'Tinidazol', concentracao: '500mg', forma: 'comprimido', comerciais: ['Amplium 500mg', 'Fasigyn 500mg'], controle: 'antimicrobiano' },
  { principio: 'Tinidazol', concentracao: '1g', forma: 'comprimido', comerciais: ['Amplium 1g'], controle: 'antimicrobiano' },
  { principio: 'Levamisol', concentracao: '150mg', forma: 'comprimido', comerciais: ['Ascaridil Levamisol', 'Levamisol 150mg'] },
  { principio: 'Oxamniquina', concentracao: '250mg', forma: 'cápsula', comerciais: ['Mansil 250mg'] },

  // ── ANTI-ENJOO / VERTIGEM / CINETOSE ─────────────────────────────────────────
  { principio: 'Dimenidrinato', concentracao: '100mg', forma: 'comprimido', comerciais: ['Dramin 100mg'] },
  { principio: 'Dimenidrinato + Vitamina B6', concentracao: '50mg + 10mg/5ml', forma: 'xarope', comerciais: ['Dramin B6 Xarope'] },
  { principio: 'Dimenidrinato + Vitamina B6', concentracao: '50mg + 10mg', forma: 'comprimido', comerciais: ['Dramin B6 Comprimido'] },
  { principio: 'Cinarizina', concentracao: '25mg', forma: 'cápsula / comprimido', comerciais: ['Stugeron 25mg', 'Cinarizina 25mg', 'Ciriax 25mg'] },
  { principio: 'Cinarizina', concentracao: '75mg', forma: 'cápsula de liberação prolongada', comerciais: ['Stugeron Forte 75mg'] },
  { principio: 'Cinarizina + Dimenidrinato', concentracao: '20mg + 40mg', forma: 'comprimido', comerciais: ['Arlevert', 'Cinarizina + Dimidrinato'] },
  { principio: 'Proclorperazina', concentracao: '5mg', forma: 'comprimido', comerciais: ['Stemetil 5mg', 'Compazine 5mg'] },
  { principio: 'Proclorperazina', concentracao: '25mg', forma: 'supositório', comerciais: ['Stemetil Supositório 25mg'] },
  { principio: 'Meclizina', concentracao: '25mg', forma: 'comprimido', comerciais: ['Meclizine 25mg', 'Bonadoxina Fórmula'] },
  { principio: 'Escopolamina (Hioscina) Transdérmica', concentracao: '1mg/72h', forma: 'adesivo transdérmico (cinetose/enjoo)', comerciais: ['Scopoderm TTS', 'Transderm Scop'] },

  // ── ANTIESPASMÓDICOS ADICIONAIS ───────────────────────────────────────────────
  { principio: 'Drotaverina', concentracao: '40mg', forma: 'comprimido', comerciais: ['No-Spa 40mg', 'Drotaverina 40mg'] },
  { principio: 'Drotaverina', concentracao: '80mg', forma: 'comprimido', comerciais: ['No-Spa 80mg'] },
  { principio: 'Drotaverina', concentracao: '40mg/2ml', forma: 'solução injetável', comerciais: ['No-Spa Injetável'] },
  { principio: 'Papaverina', concentracao: '40mg', forma: 'comprimido', comerciais: ['Papaverina 40mg', 'Papavix'] },
  { principio: 'Papaverina', concentracao: '100mg/2ml', forma: 'solução injetável', comerciais: ['Papaverina Injetável 100mg/2ml'] },
  { principio: 'Flavoxato', concentracao: '200mg', forma: 'comprimido (bexiga hiperativa)', comerciais: ['Urispas 200mg'] },
  { principio: 'Hioscina N-butilbrometo + Paracetamol', concentracao: '10mg + 500mg', forma: 'sachê / comprimido efervescente', comerciais: ['Buscopan Composto Efervescente'] },

  // ── ANALGÉSICOS / TÓPICOS ESPECÍFICOS ────────────────────────────────────────
  { principio: 'Piroxicam', concentracao: '0,5%', forma: 'gel tópico', comerciais: ['Feldene Gel 0,5%', 'Piroxicam Gel'] },
  { principio: 'Capsaicina', concentracao: '0,025%', forma: 'creme tópico', comerciais: ['Zostrix 0,025%', 'Capsiderm 0,025%'] },
  { principio: 'Capsaicina', concentracao: '0,075%', forma: 'creme tópico', comerciais: ['Zostrix HP 0,075%'] },
  { principio: 'Lidocaína', concentracao: '2%', forma: 'gel tópico', comerciais: ['Xylocaine Gel 2%', 'Lidogel 2%'] },
  { principio: 'Lidocaína + Prilocaína', concentracao: '2,5% + 2,5%', forma: 'creme tópico anestésico', comerciais: ['EMLA Creme', 'Lidocaína + Prilocaína EMLA'] },
  { principio: 'Nitroglicerina', concentracao: '0,2%', forma: 'pomada retal/tópica (fissura anal)', comerciais: ['Nitroglicerina Pomada 0,2%', 'Rectogesic'] },
  { principio: 'Ácido Hialurônico', concentracao: '1%', forma: 'gel tópico (cicatrização)', comerciais: ['Hyalo4 Gel', 'Ácido Hialurônico Gel'] },

  // ── CICATRIZANTES / DERMATOLOGIA BÁSICA OTC ──────────────────────────────────
  { principio: 'Dexpantenol', concentracao: '5%', forma: 'creme (cicatrizante/hidratante)', comerciais: ['Bepantol Creme', 'Dexpantenol Creme'] },
  { principio: 'Dexpantenol', concentracao: '5%', forma: 'pomada (cicatrizante)', comerciais: ['Bepantol Pomada'] },
  { principio: 'Dexpantenol', concentracao: '250mg', forma: 'comprimido', comerciais: ['Dexpantenol Oral 250mg', 'Bepantol Derma Comprimido'] },
  { principio: 'Óxido de Zinco', concentracao: '40%', forma: 'pasta dermatológica (Pasta d\'água)', comerciais: ['Pasta d\'água', 'Lassar Pasta', 'Calamine Pasta'] },
  { principio: 'Óxido de Zinco', concentracao: '10%', forma: 'creme/pomada (fraldas/assaduras)', comerciais: ['Hipoglós', 'Desitin', 'Assolan'] },
  { principio: 'Neomicina + Bacitracina', concentracao: '3.500 UI + 250 UI/g', forma: 'pomada antibiótica tópica', comerciais: ['Nebacetin Pomada', 'Bacitracina + Neomicina'] },
  { principio: 'Neomicina + Bacitracina + Polimixina B', concentracao: '—', forma: 'pomada antibiótica tópica', comerciais: ['Bactroban Tripla Ação', 'Neosporin'] },
  { principio: 'Clorexidina', concentracao: '2%', forma: 'solução degermante (antisséptico)', comerciais: ['Clorexidina Degermante 2%', 'Peritomax 2%'] },
  { principio: 'Clorexidina', concentracao: '0,5%', forma: 'solução alcoólica tópica', comerciais: ['Clorexidina Alcoólica 0,5%', 'Chlorhexidine 0,5%'] },
  { principio: 'Iodopovidona (PVPI)', concentracao: '10%', forma: 'solução tópica', comerciais: ['Povidine 10%', 'Betadine 10%'] },
  { principio: 'Iodopovidona (PVPI)', concentracao: '10%', forma: 'pomada', comerciais: ['Betadine Pomada', 'Povidine Pomada'] },
  { principio: 'Sulfadiazina de Prata', concentracao: '1%', forma: 'creme (queimaduras)', comerciais: ['Dermazin Creme 1%', 'Sulfasil 1%'] },
  { principio: 'Calamine', concentracao: '8%', forma: 'loção/creme', comerciais: ['Caladryl Loção', 'Calamine Loção'] },

  // ── ANTIFÚNGICOS VAGINAIS / VAGINOSE ─────────────────────────────────────────
  { principio: 'Clotrimazol', concentracao: '100mg', forma: 'comprimido vaginal (3 dias)', comerciais: ['Gino-Canesten 100mg', 'Clotrimazol Vaginal 100mg'] },
  { principio: 'Clotrimazol', concentracao: '200mg', forma: 'comprimido vaginal (3 dias)', comerciais: ['Gino-Canesten 200mg'] },
  { principio: 'Clotrimazol', concentracao: '500mg', forma: 'comprimido vaginal (dose única)', comerciais: ['Gino-Canesten 500mg dose única'] },
  { principio: 'Miconazol', concentracao: '2%', forma: 'creme vaginal (7 dias)', comerciais: ['Gino-Monistat 7', 'Miconazol Creme Vaginal 2%'] },
  { principio: 'Miconazol', concentracao: '200mg', forma: 'óvulo vaginal', comerciais: ['Gino-Monistat 3'] },
  { principio: 'Miconazol + Metronidazol + Nistatina', concentracao: '100mg + 100mg + 100.000 UI', forma: 'creme vaginal', comerciais: ['Gelmax', 'Terconazol Composto'] },
  { principio: 'Nistatina', concentracao: '100.000 UI', forma: 'comprimido vaginal', comerciais: ['Mycostatin Vaginal', 'Nistatina Vaginal'] },
  { principio: 'Metronidazol', concentracao: '500mg', forma: 'comprimido vaginal (vaginose)', comerciais: ['Flagyl Vaginal 500mg'] },
  { principio: 'Metronidazol + Miconazol', concentracao: '75mg + 200mg', forma: 'gel vaginal', comerciais: ['Flagyl Gel Vaginal', 'Metrogin Gel Vaginal'] },
  { principio: 'Clindamicina', concentracao: '2%', forma: 'creme vaginal (vaginose bacteriana)', comerciais: ['Dalacin V 2%', 'Clindesse Vaginal'] },
  { principio: 'Ácido Bórico', concentracao: '600mg', forma: 'cápsula vaginal (candidíase recorrente)', comerciais: ['Ácido Bórico Vaginal 600mg'] },

  // ── TÓPICOS OROFARINGE / BUCAIS ───────────────────────────────────────────────
  { principio: 'Benzidamina', concentracao: '3mg/ml', forma: 'solução spray orofaringe', comerciais: ['Tantum Verde Spray', 'Benflogin Spray'] },
  { principio: 'Benzidamina', concentracao: '0,15%', forma: 'solução bucal (bochecho)', comerciais: ['Tantum Verde Bochecho', 'Benflogin Solução'] },
  { principio: 'Hexetidina', concentracao: '0,1%', forma: 'solução bucal (bochecho)', comerciais: ['Oraldine 0,1%', 'Hextril 0,1%'] },
  { principio: 'Clorexidina', concentracao: '0,12%', forma: 'solução bucal (bochecho)', comerciais: ['Periogard 0,12%', 'Clorexidina Bucal 0,12%'] },
  { principio: 'Clorexidina', concentracao: '0,20%', forma: 'solução bucal (bochecho pós-cirúrgico)', comerciais: ['Corsodyl 0,20%', 'Clorexidina 0,20%'] },
  { principio: 'Benzocaína', concentracao: '10mg', forma: 'pastilha orofaringe', comerciais: ['Melagrião', 'Strepsils Benzocaína', 'Benagol'] },
  { principio: 'Cloreto de Cetilpiridínio', concentracao: '1,5mg', forma: 'pastilha orofaringe (antisséptico)', comerciais: ['Cepacol Pastilha', 'Halls Defense'] },
  { principio: 'Miconazol', concentracao: '2%', forma: 'gel oral (candidíase oral)', comerciais: ['Daktarin Gel Oral 2%'] },

  // ── REIDRATAÇÃO / ELETRÓLITOS ─────────────────────────────────────────────────
  { principio: 'Sais de Reidratação Oral (SRO — OMS)', concentracao: '—', forma: 'pó para solução oral (sachê 1L)', comerciais: ['SRO OMS', 'Hidralyte Sachê', 'Pedialyte Pó'] },
  { principio: 'Sais de Reidratação Oral (SRO) + Zinco', concentracao: '—', forma: 'pó para solução oral (sachê pediátrico)', comerciais: ['SRO + Zinco Pediátrico', 'Reidralyte Zinco'] },
  { principio: 'Glicose', concentracao: '5%', forma: 'solução injetável (SF 5% — manutenção)', comerciais: ['Soro Glicosado 5%'] },
  { principio: 'Glicose', concentracao: '50%', forma: 'solução injetável (ampola hipoglicemia)', comerciais: ['Glicose 50% Injetável', 'Glicose Hipertônica 50%'] },
  { principio: 'Cloreto de Sódio', concentracao: '0,9%', forma: 'solução injetável 100ml/250ml/500ml', comerciais: ['Soro Fisiológico 0,9% EV'] },
  { principio: 'Ringer Lactato', concentracao: '—', forma: 'solução injetável 500ml', comerciais: ['Solução de Ringer com Lactato 500ml'] },
  { principio: 'Bicarbonato de Sódio', concentracao: '8,4%', forma: 'solução injetável (ampola 10ml)', comerciais: ['Bicarbonato de Sódio 8,4% Injetável'] },

  // ── NUTRIÇÃO ENTERAL / CONTRASTE / OUTROS HOSPITALARES ───────────────────────
  { principio: 'Albumina Humana', concentracao: '20%', forma: 'solução injetável (frasco 100ml)', comerciais: ['Albumina 20%', 'Buminate 20%'] },
  { principio: 'Manitol', concentracao: '20%', forma: 'solução injetável', comerciais: ['Manitol 20%'] },

  // ── DERMATOLOGIA / OFTALMO / OUTROS ESPECÍFICOS ───────────────────────────────
  { principio: 'Fluorouracil', concentracao: '5%', forma: 'creme tópico (queratose actínica)', comerciais: ['Efudix 5%', 'Fluorouracil Creme 5%'] },
  { principio: 'Tretinoin + Fluocinolona + Hidroquinona', concentracao: '0,025% + 0,01% + 4%', forma: 'creme tópico (melasma)', comerciais: ['Triluma', 'Tri-Luma Creme'] },
  { principio: 'Ácido Kojico + Hidroquinona', concentracao: '2% + 4%', forma: 'creme tópico', comerciais: ['Kojic Acid Creme', 'Retimax Manchas'] },
  { principio: 'Fenazona + Benzocaína', concentracao: '—', forma: 'solução otológica (dor de ouvido)', comerciais: ['Otalgine', 'Auralgan Otológico', 'Aurodex'] },
  { principio: 'Tobramicina', concentracao: '0,3%', forma: 'colírio', comerciais: ['Tobrex Colírio', 'Tobramicina Colírio 0,3%'] },
  { principio: 'Azitromicina', concentracao: '1,5%', forma: 'colírio', comerciais: ['AzaSite Colírio 1,5%'] },
  { principio: 'Latanoprosta', concentracao: '0,005%', forma: 'colírio (glaucoma)', comerciais: ['Xalatan 0,005%', 'Latanoprosta Colírio'] },
  { principio: 'Dorzolamida + Timolol', concentracao: '2% + 0,5%', forma: 'colírio (glaucoma)', comerciais: ['Cosopt', 'Dorzolamida + Timolol'] },
  { principio: 'Dexametasona + Tobramicina', concentracao: '0,1% + 0,3%', forma: 'colírio', comerciais: ['Tobradex Colírio', 'Tobadex'] },
  { principio: 'Colírio Lubrificante (Hialuronato de Sódio)', concentracao: '0,1%', forma: 'colírio', comerciais: ['Vismed 0,1%', 'Hialid 0,1%', 'Artelac'] },

  // ── ACETILCISTEÍNA (formas adicionais) ────────────────────────────────────────
  { principio: 'Acetilcisteína', concentracao: '200mg', forma: 'cápsula / sachê', comerciais: ['Fluimucil 200mg', 'NAC 200mg'] },
  { principio: 'Acetilcisteína', concentracao: '200mg/5ml', forma: 'xarope', comerciais: ['Fluimucil Xarope 200mg/5ml'] },
  { principio: 'Acetilcisteína', concentracao: '300mg', forma: 'sachê', comerciais: ['Fluimucil 300mg Sachê'] },

  // ── ÁCIDO ALFA-LIPÓICO / NEUROPROTEÇÃO ───────────────────────────────────────
  { principio: 'Ácido Alfa-lipóico (ALA)', concentracao: '600mg', forma: 'comprimido (neuropatia diabética)', comerciais: ['Tiobec 600mg', 'ALA 600mg', 'Neuropack'] },
  { principio: 'Ácido Alfa-lipóico (ALA)', concentracao: '300mg', forma: 'cápsula', comerciais: ['Ácido Alfa-lipóico 300mg'] },
  { principio: 'Benfotiamina + Vitamina B6 + B12', concentracao: '100mg + 100mg + 1000mcg', forma: 'comprimido (neuropatia)', comerciais: ['Milgamma', 'Benfotiamina Composto'] },

  // ── SUPLEMENTOS ADICIONAIS ────────────────────────────────────────────────────
  { principio: 'Sulfato Ferroso', concentracao: '40mg', forma: 'comprimido (profilaxia / tratamento)', comerciais: ['Sulfato Ferroso 40mg', 'Noripurum Oral 40mg'] },
  { principio: 'Carbonato de Cálcio + Vitamina D3', concentracao: '500mg + 200 UI', forma: 'comprimido mastigável', comerciais: ['Caltrate 500+D', 'Calcigenol 500mg'] },
  { principio: 'Carbonato de Cálcio + Vitamina D3', concentracao: '1,25g + 400 UI', forma: 'comprimido', comerciais: ['Caltrate 600+D', 'Oscal 600mg+D'] },
  { principio: 'Vitamina D3 (Colecalciferol)', concentracao: '400 UI/ml', forma: 'solução oral (gotas neonato/lactente)', comerciais: ['Addera D3 400 UI', 'Vitamina D3 Gotas Lactente'] },
  { principio: 'Colecalciferol + Cálcio', concentracao: '20.000 UI + 1g', forma: 'sachê para solução oral', comerciais: ['Addera D3 20000 UI + Cálcio Sachê'] },

  // ── DERMATOLOGIA / OUTROS (complemento) ──────────────────────────────────────
  { principio: 'Amônia Quaternária + Benzalcônio', concentracao: '—', forma: 'spray tópico (inseto/alívio picada)', comerciais: ['After Bite', 'Stingose'] },
  { principio: 'Permetrina', concentracao: '1%', forma: 'loção (piolho — Pediculus capitis)', comerciais: ['Nix 1%', 'Permetrina Loção 1%'] },
  { principio: 'Lindano', concentracao: '1%', forma: 'xampu / loção (escabiose/pediculose)', comerciais: ['Kwell 1%', 'Lindano Loção'] },
  { principio: 'Enxofre Precipitado', concentracao: '6%', forma: 'pomada (escabiose neonatal)', comerciais: ['Enxofre 6% Pomada'] },
  { principio: 'Clindamicina + Peróxido de Benzoíla', concentracao: '1,2% + 2,5%', forma: 'gel (acne)', comerciais: ['Duac Gel', 'Clindamicina + BPO Gel'] },
  { principio: 'Nicotinamida (Niacinamida)', concentracao: '4%', forma: 'gel tópico (acne/poros)', comerciais: ['Niacinamida 4% Gel', 'Niacin Gel Tópico'] },
]
