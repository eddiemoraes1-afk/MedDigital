        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-[#19382E] flex items-center gap-2">
              <Building2 className="w-6 h-6 text-[#6E8570]" /> Empresas
            </h1>
        ...
        <div className="grid md:grid-cols-3 gap-6">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="font-semibold text-[#19382E]">{e.nome}</p>
          ...
          <div className="md:col-span-1">
            <div className="bg-white rounded-2xl p-6 shadow-sm sticky top-6">
              <h2 className="font-bold text-[#19382E] flex items-center gap-2 mb-5">
                <Plus className="w-4 h-4 text-[#6E8570]" /> Nova empresa
              </h2>
              <CriarEmpresaForm />
            </div>
          </div>
