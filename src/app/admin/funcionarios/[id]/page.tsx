...
import {
  User, Phone, FileText, Building2, Calendar, Briefcase,
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
          <div className="flex items-start gap-5">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold text-[#19382E]">{vinculo.nome_completo}</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            <h2 className="font-bold text-[#19382E] flex items-center gap-2 mb-4">
              <Briefcase className="w-4 h-4 text-[#6E8570]" /> Dados na Empresa
            </h2>
