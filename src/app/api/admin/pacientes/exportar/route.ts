...
<head>
  <meta charset="UTF-8"/>
  <title>Relatório de Pacientes — Aduno</title>
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: Arial, sans-serif; font-size: 11px; color: #222; padding: 24px; }
    .header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; padding-bottom: 12px; border-bottom: 2px solid #19382E; }
    .logo { font-size: 18px; font-weight: bold; color: #19382E; }
    .meta { font-size: 10px; color: #666; text-align: right; }
    h2 { font-size: 14px; color: #19382E; margin-bottom: 12px; }
    table { width: 100%; border-collapse: collapse; }
    th { background: #19382E; color: white; padding: 7px 8px; text-align: left; font-size: 10px; }
...
<body>
  ...
  <div class="footer">Aduno — Relatório gerado automaticamente</div>
