    ...
    <div className="min-h-screen bg-[#F3F6F3] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          <h1 className="text-xl font-bold text-[#19382E] mb-6">Acesso à plataforma</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={carregando}
              className="w-full bg-[#19382E] hover:bg-[#6E8570] text-white py-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 disabled:opacity-60"
            >
              {carregando ? (
          ...
          <div className="mt-4 text-center">
            <Link href="/auth/forgot-password" className="text-xs text-gray-400 hover:text-[#6E8570]">
              Esqueci minha senha
            </Link>
          </div>
          ...
          <div className="mt-4 pt-4 border-t border-gray-100 space-y-3">
            <Link
              href="/cadastro"
              className="block w-full text-center bg-[#F3F6F3] hover:bg-[#EBF0EB] border border-[#6E8570] text-[#6E8570] py-3 rounded-xl font-semibold text-sm transition-colors"
            >
              Cadastre-se
            </Link>
            <Link
              href="/cadastro?tipo=medico"
              className="block w-full text-center bg-[#F3F6F3] hover:bg-[#EBF0EB] border border-[#3E6B52] text-[#3E6B52] py-3 rounded-xl font-semibold text-sm transition-colors"
            >
